...
#define C8T6_OR_ZET6   0                                                //MCU是C8T6还是ZET6。0表示C8T6，1表示ZET6。主要是堆栈大小不同
...
#define configUSE_TIME_SLICING					1						//1使能时间片调度(默认使能)
...
#define configTICK_RATE_HZ						((TickType_t)100)       //时钟节拍频率，这里设置为100，周期就是10ms
...
#define configSUPPORT_STATIC_ALLOCATION         0                       //为1时支持静态生成任务
...
#if C8T6_OR_ZET6
#define configTOTAL_HEAP_SIZE					((size_t)(20*1024))     //ZET6系统所有总的堆大小
#else
#define configTOTAL_HEAP_SIZE					((size_t)(10*1024))     //C8T6系统所有总的堆大小
